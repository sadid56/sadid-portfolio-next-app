    ...
    <div className={cn("relative", className)}>
      ...
      >
        <Image
          ...
          width={1920}
          height={1080}
          className="w-full transition-all duration-200 group-hover:brightness-[0.8] ease-out rounded-md shadow-lg border border-slate-400 h-36 md:h-[300px] object-cover"
        />
      ...
      <AnimatePresence>
        {isVideoOpen && (
          ...
          >
            ...
            >
              <motion.button className="relative -top-2 -right-[90%] md:-right-full text-white text-xl bg-neutral-900/50 ring-1 backdrop-blur-md rounded-full p-2 z-50 cursor-pointer">
